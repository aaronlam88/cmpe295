...
public class InsertEODData {
	private static String[] symbol = { "AAPL", "MSFT", "AMZN", "FB", "JPM", "JNJ", "XOM", "GOOG", "GOOGL", "BAC", "WFC",
			"T", "CVX", "HD", "UNH", "V", "PG", "PFE", "INTC", "VZ", "CSCO", "C", "BA", "CMCSA", "ABBV", "KO", "DWDP",
			"PEP", "PM", "DIS", "MRK", "MA", "WMT", "ORCL", "MMM", "NVDA", "IBM", "MCD", "AMGN", "GE", "MO", "HON",
			"NFLX", "MDT", "BMY", "GILD", "UNP", "ABT", "TXN", "UTX", "SLB", "AVGO", "ACN", "QCOM", "ADBE", "PCLN",
			"CAT", "GS", "LMT", "USB", "NKE", "PYPL", "TMO", "LOW", "COST", "SBUX", "UPS", "TWX", "MS", "LLY", "CELG",
			"CVS", "CRM", "PNC", "NEE", "CHTR", "BIIB", "CB", "MDLZ", "COP", "AXP", "BLK", "CL", "ANTM", "WBA", "FDX",
			"SCHW", "EOG", "AET", "RTN", "AMT", "GD", "DHR", "NOC", "BDX", "AGN", "BK", "AIG", "OXY", "GM", "MON",
			"CME", "DUK", "ATVI", "DE", "AMAT", "ITW", "ADP", "SYK", "SPG", "TJX", "D", "MET", "CI", "MU", "CSX",
			...
			"IVZ", "MAS", "ETR", "CTAS", "FTI", "CHRW", "L", "ANSS", "XYL", "AEE", "CBOE", "RMD", "CBG", "BEN", "NBL",
			"SNPS", "NOV", "WHR", "ULTA", "CTXS", "CHD", "MKC", "KMX", "LEN", "WYN", "LB", "CMS", "LKQ", "BHGE", "ALB",
			"ADS", "AJG", "VIAB", "PVH", "HES", "VNO", "DRI", "EQT", "NLSN", "HSIC", "DVA", "PRGO", "RJF", "PNR", "KSU",
			"XL", "ARE", "HAS", "UNM", "CNP", "COG", "HOLX", "EXPD", "AKAM", "IFF", "COO", "FMC", "KSS", "VAR", "CDNS",
			"CINF", "IT", "PKG", "HCP", "BWA", "ARNC", "HII", "CA", "ZION", "UHS", "AMG", "TIF", "JBHT", "DISH", "RE",
			"NCLH", "AVY", "QRVO", "MAA", "EXR", "FBHS", "COTY", "VRSN", "XEC", "JNPR", "SLG", "KORS", "AMD", "SNA",
			"TMK", "FFIV", "AOS", "NDAQ", "WU", "TSCO", "DRE", "UDR", "CPB", "CF", "HRL", "IRM", "LNT", "IPG", "MOS",
			"HOG", "PNW", "REG", "SNI", "AAP", "LUK", "ALK", "FRT", "PHM", "GT", "PKI", "SEE", "NI", "JEC", "FLR",
			"NRG", "M", "ALLE", "HBI", "GRMN", "GPS", "HP", "RHI", "CMG", "AES", "PBCT", "MAC", "XRX", "FLIR", "AYI",
			"SRCL", "AIV", "LEG", "NWSA", "KIM", "RL", "FL", "BHF", "JWN", "MAT", "FLS", "HRB", "NFX", "CSRA", "SCG",
			"PWR", "AIZ", "DISCK", "TRIP", "EVHC", "NAVI", "DISCA", "SIG", "RRC", "PDCO", "CHK", "UAA", "UA", "NWS",
			"^GSPC" };
	...
	public Long startOfDay() {
		if (this.date == null) {
			return Instant.now().truncatedTo(ChronoUnit.DAYS).toEpochMilli() / 1000 + 28800;
		} else {
	...
	public static void main(String[] args) {
		if (args.length > 2) {
			System.out.println("InsertEODData database [day]");
			System.exit(-1);
		}
